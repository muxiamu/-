...
printf("<body>\n");
        ...
        printf("<form action='cgic-light.cgi' method='get'>\n");
        printf("<h2 align='center'><input type='submit'name='D1' value='on'>");
        printf("&emsp;&emsp;&emsp;&emsp; <input type='submit'name='D2' value='on'>\n");
        printf("<br><input type='submit'name='D1' value='off'>");
        printf("&emsp;&emsp;&emsp;&emsp; <input type='submit'name='D2' value='off'></h2>\n");
        printf("</form>\n");
printf("</body>\n");
printf("</html>\n");
